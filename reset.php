...
<body style="margin:0;height: 100%;outline: none;color: #7e7e7e !important;">
    <div class="bg" style="font-weight: bolder;background-image: url(./images/mishi.jpeg);background-repeat: no-repeat;padding: 0;margin: 0;background-size: cover;font-family: 'Courier New', Courier, monospace;opacity: 0.9;height: auto;padding-bottom: 5vw;">
        <center>
        ...
        if ($password === $cpassword) {
            ...
            if ($res == true) {
                ...
                if ($dbmail === $username) {
                    ...
                    $mail->SMTPAuth = true;
                    $mail->SMTPSecure = 'tls';
                    $mail->Username = 'rajmishu873@gmail.com';
                    $mail->Password = '';
                    $mail->setFrom('rajmishu873@gmail.com');
                    $mail->addAddress($dbmail);
                    $mail->addReplyTo('rajmishu873@gmail.com');
                    $mail->isHTML(true);
